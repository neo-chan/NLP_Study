...
from src.utils.config import vocab_path, train_x_seg_path, train_y_seg_path, test_x_seg_path, \
...
def get_params():
    ...
    parser.add_argument('--eps', default=1e-6, help='for gradient clipping', type=float)
